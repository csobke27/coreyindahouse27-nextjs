      ...
      <div className="">
        <div className=" my-12 lg:my-24 ">
          <div>
            ...
            <article className="align-middle  max-w-4xl mx-auto">
              <div className="">
                {post?.coverImage && (
                  <Image
                    id={post.coverImage.asset?._ref || ''}
                    alt={post.coverImage.alt || ''}
                    className="rounded-sm w-3/4 mx-auto"
                    width={1024}
                    height={1024}
                    mode="cover"
              ...
              {post.content?.length && (
                <PortableText
                  className="max-w-4xl pt-6  prose-headings:font-medium prose-headings:tracking-tight"
